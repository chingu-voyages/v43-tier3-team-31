            ...
            <div className='w-full flex shadow-md mt-2 py-10 px-14'>
                ...
                <div className='flex-[0.5] px-16'>
                    <form className='flex flex-col justify-center '>
                        <h2 className='font-medium mb-4 text-gray-900 '>Title & Location</h2>
                        <div className="mb-3">
                            <label htmlFor="text" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">The food's name or your story with the ingredient</label>
                            <input type="text" id="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="input text" required />
                        </div>
                        <div className='mb-6'>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg className='w-7 h-7 text-gray-200' viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4.39348 4.09347L4.39349 4.09345C5.34998 3.13696 6.64726 2.59961 7.99994 2.59961C9.35262 2.59961 10.6499 3.13696 11.6064 4.09345C12.5629 5.04994 13.1002 6.34722 13.1002 7.69989C13.1002 9.05257 12.5629 10.3499 11.6064 11.3063L7.99994 14.9128L4.39349 11.3063L4.39348 11.3063C3.91984 10.8327 3.54413 10.2705 3.2878 9.6517C3.03147 9.03291 2.89954 8.36968 2.89954 7.69989C2.89954 7.03011 3.03147 6.36688 3.2878 5.74809C3.54413 5.12929 3.91984 4.56705 4.39348 4.09347ZM7.99994 9.79989C8.55689 9.79989 9.09104 9.57864 9.48486 9.18482C9.87869 8.79099 10.0999 8.25685 10.0999 7.69989C10.0999 7.14294 9.87869 6.6088 9.48486 6.21497C9.09104 5.82114 8.55689 5.5999 7.99994 5.5999C7.44299 5.5999 6.90884 5.82114 6.51502 6.21497C6.12119 6.6088 5.89994 7.14294 5.89994 7.69989C5.89994 8.25685 6.12119 8.79099 6.51502 9.18482C6.90884 9.57864 7.44299 9.79989 7.99994 9.79989Z" fill="#6B7280" stroke="#6B7280" />
                                    </svg>

                                </div>
                                <input type="text" id="email-address-icon" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-12 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Location" />
                            </div>
                        </div>
                        <h2 className='font-sm font-normal mb-2 text-gray-900'>Rating and Description</h2>
                        <div className="mb-2">
                        ...
                        <div className="mb-4">
                            <label htmlFor="text" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tags</label>
                            <input type="text" id="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                        </div>

                        <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 self-end">Save</button>
                    </form>
