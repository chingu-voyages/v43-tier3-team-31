...
export default function Home() {
  return (
    <>
      ...
      <div style={{ background: "linear-gradient(  rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.8)),url('/img4.png') no-repeat fixed", backgroundSize: "cover" }} className="flex justify-center items-center flex-col gap-2 w-full h-[550px] ">
      ...
      <div className="px-16 py-16">
        ...
        <div className="flex justify-center items-center gap-2 my-16">
          ...
          <span className="flex w-3 h-3 bg-gray-200 rounded-full"></span>
          <span className="flex w-3 h-3 bg-gray-200 rounded-full"></span>
          <svg fill="none" className="flex w-7 h-7" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <div style={{ backgroundImage: "linear-gradient(  rgba(0, 0,100, 0.2), rgba(0, 0, 0, 0.9)), url('/bg3.png')" }} className=" w-full bg-cover bg-no-repeat h-[800px]">
        <div className="flex flex-col w-[340px] gap-10 justify-center items-start pt-[126px] pl-[64px]">
          ...
          <div className="bg-white bg-opacity-20 shadow-md p-4 border-gray-50 rounded">
            ...
            <h2 className="text-[16px] font-bold text-white mb-2 pt-2">Browse food around the world</h2>
            <p className="text-[14px] text-white">Explore the new cuisines and insider tips on the best food worldwide, from street food to fine dining.</p>
          </div>
          <div className=" p-4 ">
            <div className="w-288 h-[3px] bg-gray-600  rounded-sm "></div>
            <h2 className="text-[16px] font-bold text-white mb-2 pt-2">Ingredient tags in the post</h2>
            <p className="text-[14px] text-white">Easily understand what's in your food contribute by the community. Create ingredient list, add notes and tags.</p>
          </div>
          <div className=" p-4 ">
            <div className="w-288 h-[3px] bg-gray-600  rounded-sm "></div>
            <h2 className="text-[16px] font-bold text-white mb-2 pt-2">Ingredient Glossary</h2>
            <p className="text-[14px] text-white">Explore the new cuisines and insider tips on the best food worldwide, from street food to fine dining.</p>
          </div>
          <div className=" p-4 ">
            <div className="w-288 h-[3px] bg-gray-600  rounded-sm "></div>
